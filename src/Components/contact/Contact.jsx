...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_eu0ctni', 'template_tq4nthz', formref.current, {
        publicKey: '1rqVk0SykS7mSaVEk',
      })
      .then(
        () => {
          setSuccess(true)
  ...
  return (
    <motion.div ref={ref} className='contact' variants={variants} initial="initial" whileInView="animate">
      <motion.div className="textcontainer" variants={variants}>
        <motion.h2 variants={variants}>Let's Work<br /> Togather</motion.h2>
        <motion.div className="conlinks" variants={variants} initial="initial" whileInView="animate">
      ...
      <div className="formcontainer">
        ...
        >
          <svg width="450px" height="400px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13.5 2C13.5 2 15.8335 2.21213 18.8033 5.18198C21.7731 8.15183 21.9853 10.4853 21.9853 10.4853" stroke="orange" stroke-width="1.5" stroke-linecap="round" />
